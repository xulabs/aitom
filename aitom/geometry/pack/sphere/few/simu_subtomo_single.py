...
op = {'map': {'situs_pdb2vol_program': '/shared/opt/local/img/em/et/util/situs/Situs_2.7.2/bin/pdb2vol',
      ...
      'tomo': {'model': {'missing_wedge_angle': 30, 'SNR': 500000000},
               'ctf': {'pix_size': 1.0, 'Dz': -5.0, 'voltage': 300, 'Cs': 2.0, 'sigma': 0.4}}, 'target_size': 32,
      'v': None}

packing_op = {'target': '1bxn', 'random_protein_number': 4, 'PDB_ori_path': op['map']['pdb_dir'], 'iteration': 5001,
              'step': 1, 'show_img': 1, 'show_log': 1}
