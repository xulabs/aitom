...
class CycleGAN:
  ...
  def model(self):
    ...
    G_loss =  G_gan_loss + 10 * cycle_loss
    ...
    F_loss = F_gan_loss + 10 * cycle_loss
    ...
    return G_loss, D_Y_loss, F_loss, D_X_loss, fake_y, fake_x, cycle_loss, G_gan_loss, F_gan_loss
  ...
  def discriminator_loss(self, D, y, fake_y, use_lsgan=True):
    ...
    if use_lsgan:
      ...
      interpolates = y + tf.reshape(
              (alpha * tf.reshape(differences, [self.batch_size, 40*40*40])), [self.batch_size, 40, 40, 40, 1])
