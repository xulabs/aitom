...
def train_model(siamese, optimizer, train_loader, test_loader, device,
    ...
    for epoch in range(start_epoch, n_epochs + 1):
        ...
        for batch_idx, images in enumerate(train_loader):
            ...
            data = images.reshape(batch_size, 3, pixel, pixel)
        ...
        if epoch % 10 == 0 and epoch_valid_loss[epoch] < valid_loss_min:
            ...
            save_ckp(checkpoint, './best_model_Harmony_color_' + dataset_name + 'z_dim_{}.pt'.format(z_dim))
            valid_loss_min = epoch_valid_loss[epoch]
